...
public:
  ...
  panda::ArenaAllocator* _pandaAllocator{nullptr};
  ...
  ASMJIT_INLINE explicit Zone(size_t blockSize, size_t blockAlignment = 1, panda::ArenaAllocator* pandaAllocator = nullptr) noexcept
    : _pandaAllocator(pandaAllocator) {
    _init(blockSize, blockAlignment, nullptr);
  }

  ASMJIT_INLINE Zone(size_t blockSize, size_t blockAlignment, const Support::Temporary& temporary, panda::ArenaAllocator* pandaAllocator = nullptr) noexcept
    : _pandaAllocator(pandaAllocator) {
